...
const AllFeaturesBanner = () => {
  ...
  return (
    <div
      ...
      className=" all-feature w-full lg:h-[450px] md:h-[290px] h-[200px] rounded-[20px] flex items-start justify-center  py-[clamp(20px,2.5vh,30px)] px-3.5 relative"
    >
      <span
        className={`absolute z-10 right-0 w-full h-full -mt-1 transition-all duration-1000 transform  bg-white rotate-12  ease-in-out ${
