...
const SMSGatewayAndMailConfig = () => {
  return (
    <div className="space-y-5 px-5 py-10 lg:shadow-2xl md:shadow-xl shadow-lg rounded-[10px] lg:order-none order-2">
      <div className="text-center font-semibold [font-size:_clamp(14px,2.5vw,18px)]">
        {" "}
        <HighlightText>SMS Gateway & Mail Config</HighlightText>
      </div>
...
export default SMSGatewayAndMailConfig;
